...
class StockTradingEnvStopLoss(gym.Env):
    ...
    def __init__(
        ...
        """
        DataFrame to hold data for investing and investing.
        ...
        Args:
            ...
            stoploss_penalty: write your description
            profit_loss_ratio: write your description
    ...
    def get_reward(self):
        """
        Calculates the reward of the current step.
    ...
    def get_multiproc_env(self, n=10):
        """
        Get multiproc environment for the current process.
    ...
    def save_action_memory(self):
        """
        Returns a DataFrame of actions and transaction memory.
