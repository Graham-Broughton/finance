...
class StockEnvNAS89(gym.Env, ABC):
    ...
    def load_data(self, cwd='../', ticker_list=None, tech_indicator_list=None,
        ...
        data_path_array = f'{"FinRLPodracer/finrl"}/StockEnv_{data_name}_arrays_float16.npz'
        data_turb_array = f'{"FinRLPodracer/finrl"}/StockEnv_{data_name}_turbulence.npy'
