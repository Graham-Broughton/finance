...
IF_GA = True  # todo
if IF_GA:
    from elegantrl.run_ga import Arguments, train_and_evaluate_mp, train_and_evaluate_mg
else:
    from elegantrl.run import Arguments, train_and_evaluate_mp, train_and_evaluate_mg
...
def demo_custom_env_finance_rl_nas89():  # 1.7+ 2.0+
    ...
    from finrl.StockTrading import StockEnvNAS89
    args.gamma = 0.999
