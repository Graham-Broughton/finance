...
class FeatureEngineer:
    ...
    def clean_data(self, data):
        ...
        # combination,columns=["date","tic"]).merge(df,on=["date","tic"],how="left")
    ...
    def add_technical_indicator(self, data):
        ...
        # df = df.join(df.groupby(level=0, group_keys=False)
        # .apply(lambda x, y: Sdf.retype(x)[y], y=self.tech_indicator_list))
