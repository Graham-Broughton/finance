...
class StockTradingEnv(gym.Env):
    ...
    def step(self, actions):
        """
        Takes one step of the simulation and outputs the state reward terminal and rewards.
    ...
    def save_state_memory(self):
        """
        Saves state memory of the market.
    ...
    def save_asset_memory(self):
        """
        Returns a dataframe of the current memory values.
    ...
    def save_action_memory(self):
        """
        Returns actions_memory dataframe.
